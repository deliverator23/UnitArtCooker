...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/ArtDev/Units/Hwacha/04_GameData/Textures/Hwacha_n.tga"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>985140608</m_ExportedTime>
	<m_ClassName text="Generic_Normal"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="Hwacha_n.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="Hwacha_n"/>
	<m_Description text=""/>
	<m_Tags/>
	<m_Groups/>
</AssetObjects..TextureInstance>
