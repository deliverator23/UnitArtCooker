...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/ArtDev/Units/Huszar/04_GameAsset/Textures/Huszar_gloss.tga"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>3311958340</m_ExportedTime>
	<m_ClassName text="Generic_Gloss"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="Huszar_gloss.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="Huszar_gloss"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
