...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="D:\Civ6Mod\3D\AfricanElephant\AfricanForestElephant_ao.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>3403410398</m_ExportedTime>
	<m_ClassName text="Generic_AO"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="AfricanForestElephant_ao.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="AfricanForestElephant_ao"/>
	<m_Description text=""/>
	<m_Tags/>
	<m_Groups/>
</AssetObjects..TextureInstance>
