...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/ArtDev/Units/Hwacha/04_GameData/Textures/Hwacha_ao.tga"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>59791257</m_ExportedTime>
	<m_ClassName text="Generic_AO"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="Hwacha_ao.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="Hwacha_ao"/>
	<m_Description text=""/>
	<m_Tags/>
	<m_Groups/>
</AssetObjects..TextureInstance>
