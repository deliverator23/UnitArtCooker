...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/ArtDev/Units/Hwacha/04_GameData/Textures/Hwacha_m.tga"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>930225117</m_ExportedTime>
	<m_ClassName text="Generic_Metalness"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="Hwacha_m.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="Hwacha_m"/>
	<m_Description text=""/>
	<m_Tags/>
	<m_Groups/>
</AssetObjects..TextureInstance>
