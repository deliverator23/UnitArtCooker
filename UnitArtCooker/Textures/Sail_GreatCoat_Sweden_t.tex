...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="D:\Civ6Mod\3D\Swedish_Kronan\Sail_GreatCoat_Sweden_t.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>1169555385</m_ExportedTime>
	<m_ClassName text="Generic_TintMask"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="Sail_GreatCoat_Sweden_t.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="Sail_GreatCoat_Sweden_t"/>
	<m_Description text=""/>
	<m_Tags/>
	<m_Groups/>
</AssetObjects..TextureInstance>
