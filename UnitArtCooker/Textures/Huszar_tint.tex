...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/ArtDev/Units/Huszar/04_GameAsset/Textures/Huszar_tint.tga"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>3386692994</m_ExportedTime>
	<m_ClassName text="Generic_TintMask"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="Huszar_tint.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="Huszar_tint"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
